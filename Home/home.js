  ...
  data: {
    ...
    countries: [
      ...
      { name: "Angola", image_src: "../Assets/Flag_Images/Angola.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Antigua and Barbuda.png",
      },
      ...
      { name: "Bolivia", image_src: "../Assets/Flag_Images/Bolivia.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Bosnia and Herzegovina.png",
      },
      ...
      {
        name: "Burkina Faso",
        image_src: "../Assets/Flag_Images/Burkina Faso.png",
      },
      ...
      { name: "Cape Verde", image_src: "../Assets/Flag_Images/Cape Verde.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Central African Republic.png",
      },
      ...
      {
        name: "Cook Islands",
        image_src: "../Assets/Flag_Images/Cook Islands.png",
      },
      ...
      {
        name: "El Salvador",
        image_src: "../Assets/Flag_Images/El Salvador.png",
      },
      { name: "England", image_src: "../Assets/Flag_Images/England.png" },
      {
        name: "Equatorial Guinea",
        image_src: "../Assets/Flag_Images/Colombia.png",
      },
      ...
      {
        name: "Guinea-Bissau",
        image_src: "../Assets/Flag_Images/Guinea-Bissau.png",
      },
      ...
      {
        name: "Ivory Coast",
        image_src: "../Assets/Flag_Images/Ivory Coast.png",
      },
      ...
      {
        name: "Liechtenstein",
        image_src: "../Assets/Flag_Images/Liechtenstein.png",
      },
      ...
      { name: "Malta", image_src: "../Assets/Flag_Images/Malta.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Marshall Islands.png",
      },
      ...
      {
        name: "Netherlands",
        image_src: "../Assets/Flag_Images/Netherlands.png",
      },
      {
        name: "New Zealand",
        image_src: "../Assets/Flag_Images/New Zealand.png",
      },
      ...
      {
        name: "North Korea",
        image_src: "../Assets/Flag_Images/North Korea.png",
      },
      ...
      { name: "Rwanda", image_src: "../Assets/Flag_Images/Rwanda.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Saint Kitts and Nevis.png",
      },
      {
        name: "Saint Lucia",
        image_src: "../Assets/Flag_Images/Saint Lucia.png",
      },
      { name: "Samoa", image_src: "../Assets/Flag_Images/Samoa.png" },
      { name: "San Marino", image_src: "../Assets/Flag_Images/San Marino.png" },
      {
        name: "Saudi Arabia",
        image_src: "../Assets/Flag_Images/Saudi Arabia.png",
      },
      ...
      {
        name: "Sierra Leone",
        image_src: "../Assets/Flag_Images/Sierra Leone.png",
      },
      ...
      { name: "Slovenia", image_src: "../Assets/Flag_Images/Slovenia.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/Solomon Islands.png",
      },
      { name: "Somalia", image_src: "../Assets/Flag_Images/Somalia.png" },
      {
        name: "South Africa",
        image_src: "../Assets/Flag_Images/South Africa.png",
      },
      {
        name: "South Korea",
        image_src: "../Assets/Flag_Images/South Korea.png",
      },
      {
        name: "South Sudan",
        image_src: "../Assets/Flag_Images/South Sudan.png",
      },
      { name: "Spain", image_src: "../Assets/Flag_Images/Spain.png" },
      { name: "Sri Lanka", image_src: "../Assets/Flag_Images/Sri Lanka.png" },
      {
        name: "St Vincent and the Grenadines",
        image_src: "../Assets/Flag_Images/St Vincent and the Grenadines.png",
      },
      ...
      {
        name: "Switzerland",
        image_src: "../Assets/Flag_Images/Switzerland.png",
      },
      ...
      { name: "Ukraine", image_src: "../Assets/Flag_Images/Ukraine.png" },
      {
        ...
        image_src: "../Assets/Flag_Images/United Arab Emirates.png",
      },
      {
        name: "United Kingdom",
        image_src: "../Assets/Flag_Images/United Kingdom.png",
      },
      {
        name: "United States",
        image_src: "../Assets/Flag_Images/United States.png",
      },
      ...
      {
        name: "Vatican City",
        image_src: "../Assets/Flag_Images/Vatican City.png",
      },
